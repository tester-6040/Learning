    ...
    <div class="max-w-7xl mx-auto p-6 space-y-6">
        <header class="bg-white shadow rounded-xl p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <form method="GET" class="flex gap-2 items-end">
                ...
                <a class="bg-emerald-600 text-white px-4 py-2 rounded-lg" href="/api/attendance/export?month=<?= htmlspecialchars($month) ?>">Export CSV</a>
            </form>
        </header>
...
submitForm('employeeForm', '/api/employees');
